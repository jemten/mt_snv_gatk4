# mt_snv_gatk4: Reference Genomes Configuration

The mt_snv_gatk4 pipeline needs a reference genome for alignment and annotation. If not already available, start by downloading the relevant reference, for example from [illumina iGenomes](https://support.illumina.com/sequencing/sequencing_software/igenome.html).
...
```nextflow
includeConfig '/path/to/mt_snv_gatk4/conf/igenomes.config'
```
