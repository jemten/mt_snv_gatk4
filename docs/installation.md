# mt_snv_gatk4 Installation

To start using the mt_snv_gatk4 pipeline, there are three steps described below:
...
This pipeline itself needs no installation - NextFlow will automatically fetch it from GitHub if `nf-core/mt_snv_gatk4` is specified as the pipeline name.
...
```bash
wget https://github.com/nf-core/mt_snv_gatk4/archive/master.zip
unzip master.zip -d /my-pipelines/
cd /my_data/
nextflow run /my-pipelines/mt_snv_gatk4-master
```
